...
$id_empresa = base64_decode($_REQUEST['emp']);
...
<style>
	...
	.header-search{
		text-align: center;
						...
						<div class="col-md-3 clearfix">
							<div class="header-ctn">
								...
								<?php if(!isset($_SESSION['id'])){ ?>
								<div class="dropdown">
									<a class="dropdown-toggle" aria-expanded="true" href="index.php?s=n">
			...
			<div class="container">
				...
				<div id="responsive-nav">
					...
					<ul class="main-nav nav navbar-nav">
						...
						<li class="active"><a href="comercios.php">Comercios</a></li>
					</ul>
					<!-- /NAV -->
				</div>
				<!-- /responsive-nav -->
					...
					<div id="store" class="col-md-12">
						...
						<div class="store-filter clearfix">
							<div class="store-sort">
								<label>
									Mostrando:
									<select class="input-select" id="select" onchange="fnSelect(<?php echo $id_empresa ?>);">
		...
		<script src="promociones_cc.js"></script>
		<?php 
			$sql = $conn->buscar("empresas","*","id_empresa='$id_empresa'");
		 ...
		 ?>
		<script>
			fnMostrarPromociones(<?php echo $id_empresa; ?>);
